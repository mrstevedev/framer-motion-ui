...
export default function Register() {
    const handleOnSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log("Remember, this was just to look at animations. Not test if I validated the form.");
    };
    return (
        <>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <p className="mt-10 text-center text-sm/6 text-slate-400">
                        Have an account?{" "}
                        <Link to="/login" className="font-semibold text-slate-200 hover:text-slate-300">
                            {" "}
                            Login
                        </Link>
                    </p>
